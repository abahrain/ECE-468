...
public class Micro 
{
  public static void main(String[] args) throws Exception
  {
	try
	{
		...
		visited.visit(tree);
		Liveness CFG = new Liveness(visited.output, visited.tableMap, listen.table);
		System.out.print(new TinyDancer(visited.output, listen.table, visited.tableMap, visited.tempMap, CFG.CFG, 4, visited.finalTempIndex));
